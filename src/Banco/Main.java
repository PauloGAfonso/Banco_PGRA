...
public class Main {
            ...
            while (access) {
                ...
                switch (escolha) {
                    ...
                    case 3:
                        ...
                        conta.transferência(user, leitor);
                        break;
                    case 4:
    ...
    public static boolean cadastrandoUsuario(Titular titular, Conta conta, Scanner leitor) throws Exception {
        ...
        do {
            ...
            if (nomeCompleto != null && !nomeCompleto.isEmpty() && cpf.length() == 11 && cpf.matches("\\d{11}")
                    && idade >= 18) {
                titular.setCpfs(cpf);
                ...
                System.out.println(
                        "Informações preenchidas erroneamente, repite o passo a passo e preencha os campos corretamente.");
                Thread.sleep(4000);
                limpaTela();
            }
        } while (!titularCadastrado);
